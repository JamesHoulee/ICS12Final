...
/**
 * The Test class extends JDialog and implements ActionListener. This class
 * creates a new JDialog representing the player's math test. It lays out
 * questions for the player to answer. Wrong answers make Alex more anxious.
 * 
 * <p>
 ...
 * <p>
 * <b>q2B </b> This variable represents the second option for the second
 * question
 * <p>
...
public class Test extends JDialog implements ActionListener {
  ...
  /**
   * This is the constructor for the Test class. This constructor instatiates all
   * the required text fields and buttons and it sets up the constraints for all
