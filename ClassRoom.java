...
/**
 * The ClassRoom class extends LevelFramework. This class defines how any
 ...
 * <p>
 * <b>teacherSprite </b> This variable holds the information of an Images object
...
public abstract class ClassRoom extends LevelFramework {
  ...
  /**
   * This is the constructor for the ClassRoom class. This constructor instatiates
  ...
  public ClassRoom() {
    ...
    /**
     * This instantiates a new Images object with a location of "TeacherSprite.png"
     * and a dimensions 200 by 200
     */
   ...
   * input. This method defines the boundaries of the game. It also defines the
   * locations of events in the game such as when the anxiety bar has to change.
   * 
  ...
  /**
   * The update method redefines the constraints of any objects that can move or
   * change
   */
  @Override
  public void update() {
