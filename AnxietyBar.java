...
public class AnxietyBar extends JPanel {
  ...
  /**
   * The getPreferredSize method returns the dimensions for the anxietyBar when it
   * is on screen.
   * 
  ...
  /**
   * The paintComponent method draws a 135 by 40 rectangle. It then sets the color
   * to be red and fills a rectangle within the black rectangle with dimensions
   * according to the percent that is being requested to be filled defined by the
   * anxietyPercent variable.
   * 
  ...
  /**
   * The setPercent method changes the percent of the anxiety bar that is being
   * filled
   * 
   * @param percent This variable is the value that anxietyPercent will be set to
   */
   ...
   * 
   */
  public static void increasePercent(int increase) {
