...
/**
 * The MenuButton class is a subclass of CustomButton. This class creates a
 * button with specified dimensions and a set label of "Main Menu". It also
 * overrides the mouse Clicked method to set the path variable to equal -999.
 * 
...
public class MenuButton extends CustomButton {
  ...
  /**
   * This method will paint the button with the appropriate size, with centered
   * text and correct colors
   * 
   * @param g _________________
   */
  @Override
