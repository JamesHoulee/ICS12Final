 ...
 * button
 * <p>
 * <b> friendSprite1 </b> This boolean will change to true if the user clicks
 * the button
 * <p>
 * <b> friendSprite1 </b> This variable stores the text that will be on the
 * button
 * <p>
 * <b> friendSprite1 </b> This variable represents height of the button
 * <p>
 * <b> firstText </b> This variable represents the width of the button
 * <p>
 * <b> secondText </b> This variable will store where the button leads
 * <p>
 * <b> thirdText </b> This variable will change when the user hovers over the
 * button
 * <p>
 * <b> thirdText </b> This boolean will change to true if the user clicks the
 * button
 * <p>
 * <b> thirdText </b> This variable stores the text that will be on the button
 * <p>
 * <b> speech1 </b> This variable represents height of the button
 * <p>
 * <b> speech1 </b> This variable represents the width of the button
 * <p>
 * <b> speech1 </b> This variable will store where the button leads
 * <p>
 * <b> speech1 </b> This variable will store where the button leads
 * <p>
 * <b> speech1 </b> This variable will store where the button leads
...
public class HelpingAlex extends LevelFramework {
  ...
  /**
   * This is the constructor of the HelpingAlex class and is responsible for
   * instantiating all the images that will show up on the screen.
   */
  public HelpingAlex() {
  ...
  /**
   * The yard method is responsible for creating the yard image as setting up
   * times and getting up text in the set screen.
   * 
   */
  public void yard() {
  ...
  /**
   * This method will update the screen when a change is made. It will change the
   * x and y coordinates according to changes in the keyPressed () method.
   */
  @Override
  public void update() {
  ...
  /**
   * This method will return true when alex is in the yard.
   */
  ...
  /**
   * This method will return false when alex leaves the yard
   */
